...
.. note::
    ...
    To disable Flashstaking, use the :doc:`Advanced mode and uncheck "Flashstake your stake" </flashstake/advanced-mode>`.
...
.. hint::
    ...
    To do so, use the :doc:`Advanced mode and check "Mint stake as NFT" </flashstake/advanced-mode>`.
